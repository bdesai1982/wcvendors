...
class CapabilitiesGeneralFrontEndSalesReportCest
{
    ...
    // Validating admin panel option with checkbox text as -  Allow vendors to view sales table on the frontend on the vendors dashboard page.
    public function tryToTest(AcceptanceTester $I)
    {
		//Vendor observes the sales report.
		...
		//Vendor does not view sales report.
		$I->fillField('#username', 'vendor1');
		$I->fillField('#password', '#*mr4Xk)R2l)W^XuI^P85jP');
		$I->click('Log in');
		$I->click('Vendor Dashboard');
