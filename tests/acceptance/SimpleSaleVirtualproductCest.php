...
class SimpleSaleVirtualproductCest
{
  ...
  public function frontpageWorks(AcceptanceTester $I)
  {
    ...
    $I->click('Add product');
    $I->fillField('#post_title','Simple Sale Virtual product');
    ...
    $I->click('Log in');
    $I->fillField('#woocommerce-product-search-field-0', 'Simple Sale Virtual product');//searching for the product.
    ...
    $I->click('Log out');
      ...
      $I->fillField('#post-search-input', 'Simple Sale Virtual product');//searching for the product added by vendor.
