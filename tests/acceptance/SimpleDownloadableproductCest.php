...
class SimpleDownloadableproductCest
{
  ...
  public function frontpageWorks(AcceptanceTester $I)
  {
    ...
    $I->click('Add product');
    $I->fillField('#post_title','Simple Downloadable product');
    ...
    $I->click('Log in');
    $I->fillField('#woocommerce-product-search-field-0', 'Simple Downloadable product');//searching for the product.
    ...
    $I->click('Log out');
      ...
      $I->fillField('#post-search-input', 'Simple Downloadable product');//searching for the product.
      ...
      $I->see('order details');
      $I->see('Simple Downloadable product');
