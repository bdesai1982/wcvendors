...
class SimpleVirtualproductCest
{
  ...
  public function frontpageWorks(AcceptanceTester $I)
  {
    ...
    $I->click('Add product');
    $I->fillField('#post_title','Simple Virtual product');
    ...
    $I->click('Log in');
    $I->fillField('#woocommerce-product-search-field-0', 'Simple Virtual product');//searching for the product.
    ...
    $I->fillField('#post-search-input', 'Simple Virtual product');//searching for the product added by vendor.
